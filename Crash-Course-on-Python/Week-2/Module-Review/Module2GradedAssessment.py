...
# just the fractional part (a number between 0 and 1). Complete the body of the function so that
# it returns the right number. Note: Since division by 0 produces an error, if the denominator is 0,
